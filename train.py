...
from torchvision.models.detection.ssd import SSD300_VGG16_Weights, SSD, SSDHead
...
model.head = SSDHead(in_channels, num_anchors, 2)
...
if __name__ == '__main__':
    ...
    for epoch in range(1, epochs+1):
        for i, (images, targets) in enumerate(train_loader):
            ...
            wandb.log({
                "loss": losses,
                "Classifier": loss_dict["classification"],
                "Regression": loss_dict["bbox_regression"]
            })
            ...
            if (i+1) % 10 == 0:
                print(f'Epoch {epoch} - Total: {losses:.4f}, Classifier: {loss_dict["classification"]:.4f}, Regression: {loss_dict["bbox_regression"]:.4f}')
